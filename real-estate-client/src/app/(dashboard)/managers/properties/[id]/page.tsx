  ...
  return (
    <div className="dashboard-container">
      ...
      <Link
        ...
        className="flex items-center mb-4 hover:text-gray-500 font-bold"
        scroll={false}
      >
        ...
        <div className="mt-8 bg-white rounded-xl shadow-md overflow-hidden p-6">
          <div className="flex justify-between items-center mb-4">
            ...
            <div>
              ...
              px-4 rounded-md flex items-center justify-center hover:bg-gray-700 hover:text-gray-50`}
              >
                ...
                {leases?.map((lease) => (
                  <TableRow key={lease.id} className="h-24">
                    ...
                    <TableCell>
                      ...
                      items-center justify-center font-semibold hover:bg-gray-700 hover:text-gray-50`}
                      >
