...
const listApplications = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const formattedApplications = yield Promise.all(applications.map((application) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            return Object.assign(Object.assign({}, application), { property: Object.assign(Object.assign({}, application.property), { address: application.property.location.address }), manager: application.property.manager, lease: lease
